...
namespace ATL
{
    ...
    public:
        ...
        /** Sets the item at the zero-based index position.
         *  If the specified index is invalid no operation is performed.
         *  \param index is a zero-based index that has to be greater or equal to 0 (zero) and smaller than MaxItems.
         *  \param value is the itam to put at index.
         */
        ...
        /** Clears the array with default values of T.
         */
        inline void Clear()
        {
            for (int16_t i = 0; i < MaxItems; i++)
                _arr[i] = Default<T>::DefaultOfT;
        }
