...
#ifndef __HD44780_PROFILE2_H__
#define __HD44780_PROFILE2_H__
...
namespace ATL
{
    ...
    public:
        ...
        /** Performs a delay the display needs to read the data.
         */
        ...
        /** Performs a delay the display needs to put the data on the bus.
         */
        inline static void WaitReadEnable()
        {
            Delay<TimeResolution::Microseconds>::Wait(20);
            // Delay<TimeResolution::Microseconds>::Wait(8);
        }
