...
namespace ATL
{
    ...
    /** The Scheduler class is used count-down timer values typically used in Tasks.
    ...
    template <class TimeT, const uint8_t MaxItems>
    TimeT Scheduler<TimeT, MaxItems>::_time;

    template <class TimeT, const uint8_t MaxItems>
    uint32_t Scheduler<TimeT, MaxItems>::_delta = 0;

    template <class TimeT, const uint8_t MaxItems>
    uint16_t Scheduler<TimeT, MaxItems>::_ids[] = {};

    template <class TimeT, const uint8_t MaxItems>
    uint32_t Scheduler<TimeT, MaxItems>::_delays[] = {};
